...
<?php
    ...
    $i=0;
    if ($result = mysqli_query($link, "SELECT * FROM item_basis where activity='" . $_GET['ac'] . "'"))
    {
        //$items_type = $_GET['detailname'];
...
<head>
    <title><?php echo $_POST["detailname"]; ?></title>
    <meta charset="UTF-8">
...
<body class="w3-content" style="max-width:1200px;">
    ...
    <div class="w3-main" style="margin-left:250px;">
        ...
        <header class="w3-container w3-xlarge">
            <p class="w3-left" style="font-weight:bold;"><?php if($_GET['ac'] == 'prompt1') echo "溫差推薦，任選199起"; elseif ($_GET['ac'] == 'prompt4') echo "春夏季特賣"; elseif ($_GET['ac'] == 'prompt5') echo "清爽一夏，任選145起";?></p>
            <p class="w3-right">
