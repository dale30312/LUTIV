...
<body class="w3-content" style="max-width:1200px;">
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
        ...
        <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
            ...
            <div style="margin-top: 20px;">
                ...
                <a href="./modify.php" class="w3-button w3-block w3-white w3-left-align">修改密碼</a>
        ...
        <div class="w3-display-container w3-container" style="border: #64F4AA 1px solid;">
            <form name="form1" action="" method="POST" id="form1">
                <table align="center" style="padding: 20px;">
                    <tr>
                        <td>
                            舊密碼 : <input type="password" name="pw" style="font-size:15px" placeholder="*請輸入舊密碼(6~12字元)" maxlength="12" minlength="6" required onkeyup="sendRequest()">
                        </td>
                        <td>
                     ...
                     <tr>
                        <td>
                            新密碼 : <input type="password" name="pw1" style="font-size:15px" placeholder="*請輸入新密碼(6~12字元)" maxlength="12" minlength="6" required>
                        </td>
                        <td>
                            <label class="error" for="pw"></label>
                        </td>
 ...
 <script>
      ...
      xhttp.onreadystatechange = function() {
         if (this.readyState == 4 && this.status == 200) {
            if (this.responseText=='1') 
                ...
                {
                    document.getElementById('show_msg').innerHTML = '舊密碼不正確';
                    $check = 0;
                }    
          
         }
      };
      var url='check_modify.php?pw=' + document.form1.pw.value +'&pw1=' + document.form1.pw1.value +'&timeStamp='+new Date().getTime();
   ...
   <script>
    ...
    if($check == 0)
        alert('修改失敗，請檢查舊密碼是否正確');
    else
        {
            alert('修改成功');
            var xhttp = new XMLHttpRequest();
            var url='action_modify.php?pw=' + document.form1.pw.value +'&pw1=' + document.form1.pw1.value +'&timeStamp='+new Date().getTime();
            xhttp.open('GET',url,true);//建立XMLHttpRequest連線要求
            xhttp.send();
        }
    }
